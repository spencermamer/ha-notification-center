"""Switch platform for ha-notification-center."""
...
class NotificationCenterSwitch(NotificationCenterEntity, SwitchEntity):
    """ha-notification-center switch class."""
